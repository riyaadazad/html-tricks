...
Jekyll generates a full-blown site from just text, HTML, and CSS files (with a little bit of other good stuff, like YAML and Liquid, but that is beyond the scope of this article).
