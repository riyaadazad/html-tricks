...
If you use GitHub and GitHub Pages for your website, Prose makes it easy to write posts for your blogs anywhere (on your computer or on your phone or tablet), without having to be restricted to a certain computer. It will also allow you to bold, italicize, quote, add images, add unordered (bulleted) lists, add ordered (numbered) lists, and more (rejoice, fellow human!). So you would not even need to know Markdown in order to write **blog** _posts_ "with" **_style_**. However, it may not work well with alternatives to GitHub Pages, such as Netlify.